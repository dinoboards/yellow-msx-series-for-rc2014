...
By use of the included `xmodem.com` application, files can be sent to your device using xmodem.

The image has been compiled on the assumption that the second clock rate is set to 0.3072Mhz (equating to 19200, 9600 or 4800)
