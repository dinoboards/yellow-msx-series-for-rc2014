...
EXTBIO_RC2014_SERIAL:
	...
	CP	EXTBIO_RC2014_SPIKE_SET_CLKS_SUB_FN
	JR	Z, EXTBIO_RC2014_SPIKE_SET_CLKS_SUB
...
EXTBIO_RC2014_SPIKE_SET_CLKS_SUB:
	MARSHAL 5, _spike_set_clks
	JR	EXTBIO_RC2014_SERIAL_RET_OR_NEXT:
