...
// send => Cy
usb_error do_scsi_cmd(storage_device_config *const dev, _scsi_command_block_wrapper *const cbw, void *const send_receive_buffer, const bool send) {
...
usb_error scsi_read_write(storage_device_config *const dev, const bool send, uint32_t sector_number, const uint8_t sector_count, uint8_t *const buffer) {
