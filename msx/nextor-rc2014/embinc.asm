...
SECTOT	EQU	17*SECCNT
SECBNK	EQU	DRV_BANK_NO+2	; BANK ID OF FIRST SECTOR

PRES_CF		EQU	1	; BIT MASK FOR COMPACTFLASH PRESENT
PRES_MS		EQU	2	; BIT MASK FOR MSX MUSIC NOR FLASH PRESENT
PRES_USB1	EQU	4	; BIT MASK FOR USB1 STORAGE PRESENT AT BOOT UP
PRES_USB2	EQU	8	; BIT MASK FOR USB2 STORAGE PRESENT AT BOOT UP
PRES_USB3	EQU	16	; BIT MASK FOR USB3 STORAGE PRESENT AT BOOT UP
PRES_USB4	EQU	32	; BIT MASK FOR USB4 STORAGE PRESENT AT BOOT UP


BIT_PRES_CF	EQU	0	; BIT POSTION FOR COMPACTFLASH PRESENT
BIT_PRES_MS	EQU	1	; BIT POSTION FOR MSX MUSIC NOR FLASH PRESENT
BIT_PRES_USB1	EQU	2	; BIT POSTION FOR USB1 STORAGE PRESENT
BIT_PRES_USB2	EQU	3	; BIT POSTION FOR USB2 STORAGE PRESENT
BIT_PRES_USB3	EQU	4	; BIT POSTION FOR USB3 STORAGE PRESENT
BIT_PRES_USB4	EQU	5	; BIT POSTION FOR USB4 STORAGE PRESENT
