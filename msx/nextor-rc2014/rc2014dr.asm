...
DRV_INIT1:
	...
	LD	A, H					; INTERRUPT REQUIRED? INTO A
	LD	H, 0

	EX	DE, HL					; DE NOW CONTAINS THE NUMBER OF BYTES REQUIRED.
	LD	HL, ST_WRKAREA
	ADD	HL, DE

	; IF A=1 THEN SET CARRY FLAG TO ENABLE INTERRUPT HOOK
	; IF A=0 THEN CLEAR CARRY FLAG TO DISABLE INTERRUPT HOOOK
	RR	A
	RET
