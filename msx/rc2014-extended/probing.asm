...
; RTC HARDWARE IS NORMALLY MANAGED BY THE BIOS
...
; RETURN A=0 (Z) IF NOT DETECTED
; RETURN A=1 (NZ) IF YM2149F DETECTED
; RETURN A=2 (NA) IF AY-3-8910 DETECTED
GAME_PROBE:
	DI
	...
	EI
	JR	Z, GAME_DETECTED
	XOR	A			; GAME NOT DETECTED
	RET

GAME_DETECTED:
	; YM2149 WILL RETURN ALL BITS FOR ALL REGISTERS
	; AY-3-8190 WILL ONLY RETURN LOWER FOR BITS
	DI
	LD	A, 3			; SELECT REG 3 FOR WRITING
	OUT	(AY_RSEL), A
	LD	A, 255			; WRITE $55
	OUT	(AY_RDAT), A
	...
	CP	255
	EI
	JR	Z, GAME_YM2149_DETECTED

	LD	A, 2
	OR	A
	RET

GAME_YM2149_DETECTED:
	LD	A, 1
	OR	A
	RET
