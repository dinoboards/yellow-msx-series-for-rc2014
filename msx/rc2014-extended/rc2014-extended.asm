...
RS232DR_START:
	incbin	"./bin/rs232_100.bin"
RS232DR_END:

	incbin	"./bin/rs232-map.bin"
...
; 	LD	HL, RS232DR_END-RS232DR_START
; 	CALL	ALLOC
; 	LD	(WORK), HL

	; copy from RS232DR_START to HL
	; perform address translation
	; install interrupt hook

	; TODO Notes
	; user application needs to disabe vdp int during transmissions
	; sio.asm - remove SIO_PROBE
	;           remove int installer/removal
	;           add get_byte
	;           create send_byte
